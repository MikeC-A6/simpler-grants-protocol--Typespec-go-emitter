import { $deprecated, $discriminator, $doc, $encode, $encodedName, $error, $errorsDoc, $example, $format, $friendlyName, $inspectType, $inspectTypeName, $key, $knownValues, $maxItems, $maxLength, $maxValue, $maxValueExclusive, $minItems, $minLength, $minValue, $minValueExclusive, $opExample, $overload, $pattern, $projectedName, $returnsDoc, $secret, $service, $summary, $tag, $withOptionalProperties, $withPickedProperties, $withoutDefaultValues, $withoutOmittedProperties, } from "./decorators.js";
